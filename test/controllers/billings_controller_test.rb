...
class BillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post billings_url, params: { billing: { amount: @billing.amount, code: @billing.code, currency: @billing.currency, payment_method: @billing.payment_method, user_id: @billing.user_id } }
    end
  ...
  test "should update billing" do
    patch billing_url(@billing), params: { billing: { amount: @billing.amount, code: @billing.code, currency: @billing.currency, payment_method: @billing.payment_method, user_id: @billing.user_id } }
